...
Lightweight command-line and MCP access to the [Releasebot](https://releasebot.io) catalog: read release notes, changelogs, and product announcements from your terminal or as context for any AI agent.
